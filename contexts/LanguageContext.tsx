...
const translations: Record<ResolvedLanguage, Record<string, string>> = {
  en: {
    ...
    storagePlanBasicFeatureExport: "Expense and income tracking, statistics, filters, sorting, and spreadsheet export.",
    storagePlanBasicFeatureNoLogin: "No account required.",
    storagePlanPlusTitle: "Plus Local",
    storagePlanPlusPrice: "$14.99 one-time",
    ...
    storagePlanPlusFeatureBiometric: "Face ID / Touch ID lock.",
    ...
    storageUpgradeActionsSubtitle:
      "Pro purchase wiring exists now. Plus is shown for product planning and will need its own one-time purchase entitlement.",
  ...
  zh: {
    ...
    storagePlanBasicFeatureExport: "支出與收入記帳、基礎統計、篩選排序與試算表匯出。",
    storagePlanBasicFeatureNoLogin: "不需要帳號即可使用。",
    storagePlanPlusTitle: "Plus 單機買斷",
    storagePlanPlusPrice: "$14.99 一次性買斷",
    ...
    storagePlanPlusFeatureBiometric: "Face ID / Touch ID 鎖定。",
    ...
    storageUpgradeActionsSubtitle:
      "目前已串接 Pro 購買流程。Plus 先保留為產品方案，後續需補上一次性買斷 entitlement。",
