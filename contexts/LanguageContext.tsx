...
const translations: Record<ResolvedLanguage, Record<string, string>> = {
  en: {
    ...
    cloudSyncSyncCta: "Sync local data to cloud",
    cloudSyncSyncDetail: "Push this device and pull your latest cloud snapshot.",
    cloudSyncSyncConfirm: "Upload your local records to your cloud account?",
    cloudSyncSyncDone: "Uploaded {count} records.",
    cloudSyncSyncFailed: "Sync failed. Please try again.",
  ...
  zh: {
    ...
    cloudSyncSyncCta: "將本機資料同步到雲端",
    cloudSyncSyncDetail: "推送此裝置資料，並拉取最新雲端快照。",
    cloudSyncSyncConfirm: "要把本機記錄上傳到雲端帳號嗎？",
    cloudSyncSyncDone: "已上傳 {count} 筆記錄。",
    cloudSyncSyncFailed: "同步失敗，請稍後再試。",
